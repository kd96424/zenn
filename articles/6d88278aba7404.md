...
作成時に設定するScopesの説明は[こちら](https://www.figma.com/developers/api#authentication:~:text=EXPIRATION%20(in%20seconds)%3E%2C%0A%7D-,Scopes,-Scopes%20for%20personal)を参照。
...
# 動作確認
上記main.dartの「②デザイントークンの利用」backgroundColorが利用できていることが確認できる。
