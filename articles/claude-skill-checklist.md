...
emoji: "💻"
type: "tech"
topics: [ClaudeCode, AI, Agent Skills, Claude]
published: true
---
# 記事の概要
...
Tips 1 と Tips 2 を **書き換え後の軽量な検証** としてskillに組み込み、skillの修正後に検証させる。
...
を回すようskillに追加する。これだけで本格的なevalのような重い検証を回さずに「明らかな品質劣化」は防ぐことができる。
